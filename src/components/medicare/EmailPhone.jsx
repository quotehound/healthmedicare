...
const lastName = urlParams.get('last_name');
        ...
        this.setState({
            loading: true 
          }, this.postMedicare(this.props.medicarePostData));

          this.props.history.push('/medicare/thank-you' + '?lp_request_id=' + lp + '&zip_code=' + zip + '&ab=' + ab + '&gender=' + gender + '&month=' + month + '&day=' + day + '&year=' + year + '&address=' + address + '&first_name=' + firstName + '&last_name=' + lastName + '&email=' + email + '&phone_home=' + phone)
    };
...
const lastName = urlParams.get('last_name');
    ...
    postMedicare = (postMedicareData) => {
        console.log(postMedicareData);
        Axios.post("https://quotehound.leadspediatrack.com/post.do", null, {
          params: postMedicareData,
        })
